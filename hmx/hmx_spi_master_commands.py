...
from hmx.hmx_spi_master_packet_handlers import SpiMasterRxPacketsHandler
from hmx.hmx_utils import dump_bytes
from hmx.hmx_meta_data_format import *

# Set Logger
Log = logging.getLogger(HxLogger.SPI_MST_CMD)

class HmxSpiMasterCommand():
    def __init__(self, get_meta=True, get_jpeg=True, get_raw=False, get_pdm=False):
        ...
        self.rx_thread = SpiMasterRxPacketsHandler('SPI Master Rx Thread')
