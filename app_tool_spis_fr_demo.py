...
if __name__ == '__main__':
    ...
    while True:
        ...
        if JpegFrame:
            ...
            # Draw Menu
            cv2.putText(img, 'Press 1: Register', (20, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 255), 1, cv2.LINE_AA)
            cv2.putText(img, 'Press 2: Un-Register', (20, 35), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 255), 1, cv2.LINE_AA)
            cv2.putText(img, 'Press 3: Clear All', (20, 50), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 255), 1, cv2.LINE_AA)
            cv2.putText(img, 'Press q: Quit', (20, 65), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 255), 1, cv2.LINE_AA)
